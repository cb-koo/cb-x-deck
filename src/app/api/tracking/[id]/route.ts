...
import { findTrackedPostById, setDraftLink, deleteTrackedPost, setRole } from '@/lib/trackingStore';
...
export async function PATCH(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  const body = (await req.json().catch(() => ({}))) as { draftId?: unknown; role?: unknown };

-- 044: RT 작업 증빙 스크린샷 (스펙 2026-08-31-rt-proof-screenshot-design.md §4·§10)
-- 043은 외부 API 호출 기록이 먼저 main에 들어갔다 → 이 파일은 044로 옮겼다.
-- 프로덕션에는 043_task_proof.sql이라는 이름으로 이미 적용됐다 — 추가만 하는 문장들이라 재실행 안전.

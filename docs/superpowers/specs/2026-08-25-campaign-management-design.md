...
```
┌ 캠페인 목록 280px ─┬ 상세 ──────────────────────────────────────────────┐
│ [+ 새 캠페인]      │ 헤더: 이름 · 상태 pill · 클라 / 속성 블록 3칸(기간·유형·코드, 클릭 편집) / 메모(있을 때만) │
│ 진행 중 (1)        │        [+ 원고 추가] [···]                              │

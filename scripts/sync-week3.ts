...
//
// 2026-09-18 판독분. 근거: 미모드림 1789366144.350499 · 더스퀘어 1789366152.112109 · 백수약국 1789366166.539959
//
// 이 스크립트가 하는 일 4가지:
...
const ADDS: Add[] = [
  ...
  { camp: '더스퀘어치과_9월3주차', handle: 'nasu_seikei', type: 'quoteRt', amount: 80000,
    ...
    note: '09-17 14:38 답글로 추가(08번). 백수약국 3주차에도 같은 핸들·같은 금액(8만원) 작업이 따로 있다 — 2주차 @taibanchan 선례대로 별개 건으로 본다' },
];

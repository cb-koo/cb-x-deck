...
import { targetUrlOf } from './campaignJudgment.ts';
...
async function resolveQuoteTarget(sql: postgres.Sql, quoteTargetTaskId: string | null | undefined): Promise<QuoteTargetResolution> {
...
export async function generateDraft(
  ...
  const quoteTarget = await resolveQuoteTarget(sql, req.quoteTargetTaskId);
